...
class SynthesizerTrn(nn.Module):
    ...
    def __init__(self,
        ...
        self.enc_p = TextEncoder(n_vocab,
                                 ...
                                 kernel_size,
                                 p_dropout)
        self.mb_dec = Multiband_iSTFT_Generator(inter_channels, resblock, resblock_kernel_sizes,
    ...
    def forward(self, phonemes, phonemes_lengths, f0, phndur, spec, spec_lengths, sid=None):
        ...
        o, o_mb = self.mb_dec(z_slice, g=g)
    ...
    def infer(self, phonemes, phonemes_lengths,
        ...
        o, o_mb = self.mb_dec((z * x_mask)[:, :, :max_len], g=g)
